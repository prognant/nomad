...
public:
     ...
     */
    const NOMAD::Double &get_h_max(void) const
    {
        return _h_max;
    }
     ...
     */
    NOMAD::success_type get_one_eval_succ(void) const
    {
        return _one_eval_succ;
    }
     ...
     */
    NOMAD::success_type get_success(void) const
    {
        return _success;
    }
