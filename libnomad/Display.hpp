...
public:
    ...
    */
    ...
    /**
       \return _gen_dd.
    */
    NOMAD::dd_type get_gen_dd(void) const
    {
        return _gen_dd;
    }
    ...
    /**
       \return _search_dd.
    */
    NOMAD::dd_type get_search_dd(void) const
    {
        return _search_dd;
    }
    ...
    /**
       \return _poll_dd.
    */
    NOMAD::dd_type get_poll_dd(void) const
    {
        return _poll_dd;
    }
    ...
    /**
       \return _iter_dd.
    */
    NOMAD::dd_type get_iter_dd(void) const
    {
        return _iter_dd;
    }
    ...
    */
    void set_indent_str(const std::string &is)
    {
        _indent_str = is;
    }
    ...
    */
    void set_open_brace(const std::string &ob)
    {
        _open_brace = ob;
    }
    ...
    */
    void set_closed_brace(const std::string &cb)
    {
        _closed_brace = cb;
    }
    ...
    */
    void set_degrees(NOMAD::dd_type dd)
    {
        set_degrees(dd , dd , dd , dd);
    }
    ...
    */
    ...
    {
        return static_cast<int>(_out.precision());
    }
    ...
    */
    void flags(std::ios_base::fmtflags f) const
    {
        _out.flags(f);
    }
    ...
    /**
       \param f The flags -- \b IN.
    */
    void setf(std::ios_base::fmtflags f) const
    {
        _out.setf(f);
    }
    ...
    /**
       \param f The flags -- \b IN.
    */
    void unsetf(std::ios_base::fmtflags f) const
    {
        _out.unsetf(f);
    }
    ...
    */
    void display_yes_or_no(bool b) const
    {
        (*this) << ((b) ? "yes" : "no");
    }
