...
public:
     ...
     */
    explicit Stats(int sgte_cost = -1) : _sgte_cost(sgte_cost)
    {
        reset();
    }
    ...
    void add_mads_run(void)
    {
        ++_mads_runs;
    }

    /// Set the number of MADS runs.
    void set_mads_runs(int mads_runs)
    {
        _mads_runs = mads_runs;
    }
    ...
    void add_nb_success_dyn_dir(void)
    {
        ++_nb_success_dyn_dir;
    }
    ...
    /**
     \param i The integer -- \b IN.
     */
    void add_ext_poll_bb_eval(int i)
    {
        _ext_poll_bb_eval += i;
    }
    ...
    void add_asynchronous_success(void)
    {
        ++_asynchronous_success;
    }
     ...
     */
    int get_sim_bb_eval(void) const
    {
        return _sim_bb_eval;
    }
     ...
     */
    int get_failed_eval(void) const
    {
        return _failed_eval;
    }
     ...
     */
    int get_VNS_bb_eval(void) const
    {
        return _VNS_bb_eval;
    }
     ...
     */
    int get_VNS_sgte_eval(void) const
    {
        return _VNS_sgte_eval;
    }
     ...
     */
    const NOMAD::Model_Stats &get_model_stats(void) const
    {
        return _model_stats;
    }
