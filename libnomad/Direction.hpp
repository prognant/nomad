...
public:
    ...
    */
    ...
    {
        return Direction::_max_cardinality;
    }
#endif
    ...
    */
    NOMAD::direction_type get_type(void) const
    {
        return _type;
    }
    ...
    */
     ...
     */
    size_t get_dir_group_index(void) const
    {
        return _dir_group_index;
    }
    ...
    */
    bool is_mads(void) const
    {
        return NOMAD::dir_is_mads(_type);
    }
    ...
    */
    bool is_gps(void) const
    {
        return NOMAD::dir_is_gps(_type);
    }
    ...
    */
    void set_type(NOMAD::direction_type t)
    {
        _type  = t;
    }
