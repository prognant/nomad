...
public:
    ...
    */
    ...
    void reset_feas_success_dir(void) const
    {
        _feas_success_dir.clear();
    }

    /// Reset the infeasible successful direction.
    void reset_infeas_success_dir(void) const
    {
    ...
    */
    bool all_continuous(void) const
    {
    ...
    */
    bool has_categorical(void) const
    {
        return _has_categorical;
    }
    ...
    */
    ...
    {
        return static_cast<int>(_input_types.size());
    }
    ...
    */
    const NOMAD::Mesh &get_mesh(void) const
    {
        return *_mesh;
    }
    ...
    */
    ...
    {
        return Signature::_max_cardinality;
    }
#endif
