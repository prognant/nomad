...
public:
    ...
    */
    NOMAD::Cache &get_sgte_cache(void)
    {
        return *_sgte_cache;
    }
    ...
    /**
       ...
       \return The surrogate cache.
    */
    const NOMAD::Cache &get_sgte_cache(void) const
    {
        return *_sgte_cache;
    }
    ...
    */
    NOMAD::Evaluator *get_evaluator(void) const
    {
        return _ev;
    }
    ...
    */
    int get_last_stats_tag(void) const
    {
        return _last_stats_tag;
    }
    ...
    */
    int get_last_stats_bbe(void) const
    {
        return _last_stats_bbe;
    }
    ...
    */
    void set_evaluator(NOMAD::Evaluator *e)
    {
        _ev = e;
    }
    ...
    */
    void set_last_TGP_model(NOMAD::TGP_Model *m)
    {
        _last_TGP_model = m;
    }
#endif
    ...
    */
    ...
    void enable_model_eval_sort(void)
    {
        _model_eval_sort = true;
    }

    /// Disable the model ordering.
    void disable_model_eval_sort(void)
    {
    ...
    */
    int get_nb_eval_in_progress(void) const
    {
        return _nb_in_progress;
    }
