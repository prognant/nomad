...
public:
    ...
    */
    const std::list<std::string> &get_values(void) const
    {
        return _values;
    }
    ...
    */
    Parameter_Entry *get_next(void) const
    {
        return _next;
    }
    ...
    /**
       \return A boolean equal to \c true if the parameter has already
               been interpreted.
    */
    bool has_been_interpreted(void) const
    {
        return _has_been_interpreted;
    }
    ...
    */
    void set_next(Parameter_Entry *p)
    {
        _next = p;
    }
    ...
    */
    ...
    void set_has_been_interpreted(void)
    {
        _has_been_interpreted = true;
    }
    ...
    */
    bool operator < (const Parameter_Entry &p) const
    {
