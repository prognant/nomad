...
public:
    ...
    */
    static void set_display_limit(int dl)
    {
        Point::_display_limit = dl;
    }
    ...
    */
    static int get_display_limit(void)
    {
        return Point::_display_limit;
    }
    ...
    */
    const NOMAD::Double norm(void) const
    {
