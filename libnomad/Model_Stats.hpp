...
public:
    ...
    */
    ...
    /**
       \param t Time -- \b IN.
    */
    void add_construction_time(double t)
    {
        _construction_time += t;
    }
    ...
    **/
    int get_MS_nb_searches(void) const
    {
        return _MS_nb_searches;
    }
    ...
    **/
    int get_MS_sgte_eval(void) const
    {
        return _MS_sgte_eval;
    }
    ...
    **/
    int get_nb_models(void) const
    {
        return _nb_truth + _nb_sgte;
    }
    ...
    */
    int get_nb_WP_regression(void) const
    {
        return _nb_WP_regression;
    }
    ...
    */
    int get_nb_regression(void) const
    {
        return _nb_regression;
    }
