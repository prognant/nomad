...
public:
    ...
    */
    ...
    {
        return NOMAD::Double::_cardinality;
    }
    ...
    */
    ...
    {
        return NOMAD::Double::_max_cardinality;
    }
#endif
    ...
    */
    int size_of(void) const
    {
        return sizeof(_defined) + sizeof(_value);
    }
    ...
    */
    static double get_epsilon(void)
    {
        return Double::_epsilon;
    }
    ...
    */
    static std::string get_undef_str(void)
    {
        return Double::_undef_str;
    }
    ...
    */
    static std::string get_inf_str(void)
    {
        return Double::_inf_str;
    }
