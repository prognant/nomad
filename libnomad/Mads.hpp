...
public:
     ...
     */
    void set_user_search(NOMAD::Search *us)
    {
        _user_search  = us;
    }
     ...
     */
    void set_pareto_front(NOMAD::Pareto_Front *pf)
    {
        _pareto_front = pf;
    }
     ...
     */
    static void set_flag_check_bimads(bool fcb)
    {
        _flag_check_bimads = fcb;
    }
     ...
     */
    static void set_flag_reset_mesh(bool frm)
    {
        _flag_reset_mesh = frm;
    }
     ...
     */
    static void set_flag_reset_barriers(bool frb)
    {
        _flag_reset_barriers = frb;
    }
    ...
    /**
     \param fpa The flag.
     */
    static void set_flag_p1_active(bool fpa)
    {
        _flag_p1_active = fpa;
    }
     ...
     */
    NOMAD::Evaluator_Control &get_evaluator_control(void)
    {
        return _ev_control;
    }
     ...
     */
    NOMAD::Barrier &get_true_barrier(void)
    {
        return _true_barrier;
    }
     ...
     */
    NOMAD::Barrier &get_sgte_barrier(void)
    {
        return _sgte_barrier;
    }
     ...
     */
    NOMAD::Extended_Poll *get_extended_poll(void) const
    {
        return _extended_poll;
    }
     ...
     */
    NOMAD::Pareto_Front *get_pareto_front(void) const
    {
