...
public:
    ...
    explicit Parameters(NOMAD::Signature      *extern_signature ,
        ...
        : _out(out) ,
          _std_signature(NULL) ,
          _extern_signature(extern_signature)
    {
        init();
    }
...
public:
     ...
     */
    bool to_be_checked(void) const
    {
        return _to_be_checked;
    }
...
public:
    ...
    /**
     \param i Index of the variable -- \b IN.
     */
    void set_FREE_VARIABLE(int i)
    {
        set_FIXED_VARIABLE(i , NOMAD::Double());
    }
...
public:
    ...
    /**
     \return The lower bounds.
     */
    const NOMAD::Point &get_lower_bound(void) const
    {
        return get_lb();
    }
    ...
    /**
     \return The upper bounds.
     */
    const NOMAD::Point &get_upper_bound(void) const
    {
        return get_ub();
    }
...
public:
     ...
     */
    bool eval_points_as_block() const
    {
        return _eval_points_as_block;
    }
