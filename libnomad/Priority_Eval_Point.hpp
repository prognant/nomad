...
public:
     ...
     */
    void set_angle_success_dir(const NOMAD::Double &a)
    {
        _angle_success_dir = a;
    }
     ...
     */
    void set_angle_simplex_grad(const NOMAD::Double &a)
    {
        _angle_simplex_grad = a;
    }
     ...
     */
    void set_f_sgte(const NOMAD::Double &f)
    {
        _f_sgte = f;
    }
     ...
     */
    void set_h_sgte(const NOMAD::Double &h)
    {
        _h_sgte = h;
    }
     ...
     */
    void set_f_model(const NOMAD::Double &f)
    {
        _f_model = f;
    }
     ...
     */
    void set_h_model(const NOMAD::Double &h)
    {
        _h_model = h;
    }
    ...
    /**
     */
    static void set_lexicographic_order(bool order)
    {
        _lexicographic_order = order;
    }
