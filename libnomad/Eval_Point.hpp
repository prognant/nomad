...
public:
     ...
     */
    bool is_eval_ok(void) const
    {
        return (_eval_status == NOMAD::EVAL_OK);
    }
     ...
     */
    bool check_rejected(void) const
    {
        return (_eval_status == NOMAD::EVAL_USER_REJECT);
    }
     ...
     */
    const NOMAD::Double &get_f(void) const
    {
        return _f;
    }
     ...
     */
    const NOMAD::Double &get_h(void) const
    {
        return _h;
    }
    ...
    /**
     ...
     may be \c NULL if no direction has been used.
     */
    const NOMAD::Direction *get_direction(void) const
    {
        return _direction;
    }
     ...
     */
    const NOMAD::Eval_Point *get_poll_center(void) const
    {
        return _poll_center ;
    }
     ...
     */
    const int *get_mesh_index(void) const
    {
        return _mesh_index;
    }
     ...
     */
    bool get_current_run(void) const
    {
        return _current_run;
    }
     ...
     */
    NOMAD::eval_type get_eval_type(void) const
    {
        return _eval_type;
    }
     ...
     */
    NOMAD::eval_status_type get_eval_status(void) const
    {
        return _eval_status;
    }
     ...
     */
    void set_real_time(int real_time)
    {
     ...
     */
    void set_f(const NOMAD::Double &f)
    {
        _f = f;
    }
     ...
     */
    void set_h(const NOMAD::Double &h)
    {
        _h = h;
    }
     ...
     */
    void set_user_eval_priority(const NOMAD::Double &u)
    {
        _user_eval_priority = u;
    }
     ...
     */
    void set_rand_eval_priority(const NOMAD::Double &r)
    {
        _rand_eval_priority = r;
    }
     ...
     */
    void set_bb_output(int i , const NOMAD::Double &v)
    {
        _bb_outputs[i]= v;
    }
     ...
     */
    void set_bb_output(const NOMAD::Point &b)
    {
        _bb_outputs = b;
    }
    ...
    /**
     ...
     -- \b IN.
     */
    void set_eval_status(const NOMAD::eval_status_type &e)
    {
        _eval_status = e;
    }
     ...
     */
    void set_eval_type(NOMAD::eval_type e)
    {
        _eval_type = e;
    }
     ...
     */
    void set_poll_center_type(NOMAD::poll_center_type p)
    {
        _poll_center_type = p;
    }
     ...
     */
    void set_current_run(bool c) const
    {
        _current_run = c;
    }
    ...
    /**
     ...
     -- \b IN.
     */
    void set_in_cache(bool i) const
    {
        _in_cache = i;
    }
    ...
    /**
     */
    static void reset_tags_and_bbes(void)
    {
        _current_tag = 0;
        _current_bbe = 0;
        _current_sgte_bbe = 0;
...
public:
    ...
    void set_mod_use(int                 mod_use) const
    {
        _mod_use = mod_use;
    }
    void set_nY(int                     nY) const
    {
        _nY      = nY;
    }
    void set_cond(const NOMAD::Double &cond) const
    {
        _cond    = cond;
    }
    void set_Yw(const NOMAD::Double    &Yw) const
    {
        _Yw      = Yw;
    }
    void set_mh(const NOMAD::Double    &mh) const
    {
        _mh      = mh;
    }
    void set_mf(const NOMAD::Double    &mf) const
    {
        _mf      = mf;
    }

    int                   get_mod_use(void) const
    {
        return _mod_use;
    }
    ...
    const NOMAD::Double &get_cond(void) const
    {
        return _cond;
    }
    const NOMAD::Double &get_Yw(void) const
    {
        return _Yw;
    }
    const NOMAD::Double &get_mh(void) const
    {
        return _mh;
    }
    const NOMAD::Double &get_mf(void) const
    {
        return _mf;
    }
